namespace ParkFacilAdm.Models
{
    ...
    public partial class ParkFacilAdmEntities : DbContext
    {
        public ParkFacilAdmEntities()
            : base("name=ParkFacilAdmConnection")
        {
        }
        ...
        public virtual DbSet<ClienteParking> ClienteParking { get; set; }
